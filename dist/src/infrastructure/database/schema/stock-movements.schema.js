...
exports.stockMovementTypeEnum = (0, pg_core_1.pgEnum)('stock_movement_type', ['IN', 'OUT', 'ADJUSTMENT']);
exports.stockMovements = (0, pg_core_1.pgTable)('stock_movements', {
    id: (0, pg_core_1.uuid)('id').primaryKey().defaultRandom(),
    productId: (0, pg_core_1.uuid)('product_id').notNull().references(() => products_schema_1.products.id),
