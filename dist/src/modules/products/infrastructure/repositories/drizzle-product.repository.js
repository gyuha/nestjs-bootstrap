...
let DrizzleProductRepository = class DrizzleProductRepository {
  ...
  async findById(id) {
    const result = await this.db.db
      .select()
      .from(products_schema_1.products)
      .where((0, drizzle_orm_1.eq)(products_schema_1.products.id, id))
      .limit(1);
  ...
  async findAll(query) {
    ...
    if (query.categoryId)
      conditions.push(
        (0, drizzle_orm_1.eq)(products_schema_1.products.categoryId, query.categoryId),
      );
  ...
  async update(entity) {
    ...
    await this.db.db
      .update(products_schema_1.products)
      .set({ ...data, price: price.toString() })
      .where((0, drizzle_orm_1.eq)(products_schema_1.products.id, id));
  }
  async delete(id) {
    await this.db.db
      .delete(products_schema_1.products)
      .where((0, drizzle_orm_1.eq)(products_schema_1.products.id, id));
  }
